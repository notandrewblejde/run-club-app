...
/**
 * Strava OAuth onboarding: bullets + bottom-bar Connect / Skip.
 * Used from the standalone tab route and from the multi-step onboarding wizard.
 */
export default function StravaConnectPanel() {
  ...
  // Only while this screen (or parent) has focus — hidden routes like onboarding
  // can stay mounted when switching tabs; blur must clear or Discover shows these actions.
  useFocusEffect(
    useCallback(() => {
      setActions([
        {
      ...
      return () => clearActions();
    }, [request, exchanging, setActions, clearActions, promptAsync]),
  );
    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>
          Sync your runs automatically. We'll backfill your recent activities and keep them up to date as you go.
        </Text>
